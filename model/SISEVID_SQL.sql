...
CREATE TABLE EVIDENCIA_DETALLE(
	ID_EVIDENCIA_DETALLE BIGINT AUTO_INCREMENT  PRIMARY KEY,
...
CREATE TABLE USUARIO_ROLES_INTERMEDIA (
    ID BIGINT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    ID_USUARIO VARCHAR(4) NOT NULL,
    ID_USUARIO_ROLES VARCHAR(4) NOT NULL,
    FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO(ID_USUARIO),
    FOREIGN KEY (ID_USUARIO_ROLES) REFERENCES USUARIO_ROLES(ID_USUARIO_ROLES)
);
...
INSERT INTO usuario_roles(ID_USUARIO_ROLES,DESCRIPCION,USUARIO_CREACION,FECHA_CREACION) VALUES ('1','Administrador','SISTEMA',NOW());
INSERT INTO usuario_roles(ID_USUARIO_ROLES,DESCRIPCION,USUARIO_CREACION,FECHA_CREACION) VALUES ('2','Verificador','SISTEMA',NOW());
INSERT INTO usuario_roles(ID_USUARIO_ROLES,DESCRIPCION,USUARIO_CREACION,FECHA_CREACION) VALUES ('3','Validador','SISTEMA',NOW());
INSERT INTO usuario_roles(ID_USUARIO_ROLES,DESCRIPCION,USUARIO_CREACION,FECHA_CREACION) VALUES ('4','Administrativo','SISTEMA',NOW());

INSERT INTO `usuario_info_contacto` (`ID_USUARIO_INFO_CONTACTO`, `TIPO_DOCUMENTO`, `NUMERO_DOCUMENTO`, `NOMBRES`, `APELLIDOS`, `NUMERO_CONTACTO`, `EMAIL`, `USUARIO_CREACION`, `FECHA_CREACION`) VALUES
...
INSERT INTO `usuario` (`ID_USUARIO`, `ID_USUARIO_INFO_CONTACTO`, `USUARIO`, `CONTRASEÑA`, `USUARIO_CREACION`, `FECHA_CREACION`) VALUES
...
('5', '3', 'validador_verificador', '1234', 'admin', '2022-12-09 23:33:19');

INSERT INTO `usuario_roles_intermedia` (`ID`, `ID_USUARIO`, `ID_USUARIO_ROLES`) VALUES
(1, '1', '1'),
(2, '1', '2'),
(3, '5', '3'),
(4, '5', '2'),
...
INSERT INTO autor (ID_AUTOR,NOMBRES,APELLIDOS,NACIONALIDAD,FECHA_NACIMIENTO,USUARIO_CREACION,FECHA_CREACION) VALUES ('1','AUTOR', 'SISTEMAT','COLOMBIANA','1990-10-10','SISTEMA',NOW());
INSERT INTO `evidencia` (`ID_EVIDENCIA`, `TITULO`, `DESCRIPCIÓN`, `TIPO`, `TIPO_ARCHIVO`, `FECHA_CREACION_EVIDENCIA`, `FECHA_REGISTRO_EVIDENCIA`, `AUTORES`, `OBSERVACION`, `USUARIO_CREACION`, `FECHA_CREACION`) VALUES
...
INSERT INTO `evidencia_detalle` (`ID_EVIDENCIA_DETALLE`, `ID_EVIDENCIA`, `USUARIO_MODIFICACION`, `FECHA_MODIFICACION`, `ESTADO`, `ACTIVO`) VALUES
