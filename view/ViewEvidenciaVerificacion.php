...
include '../controller/VerificadorController.php';
...
if($Verificar){
    ...
    $controlador->Verficador($Verificar);
}
?>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color: #055160 !important;">
    ...
    <div class="container">
        <table class="table table-striped" style="vertical-align: initial;">
            ...
            $sql = "SELECT * FROM evidencia e INNER JOIN evidencia_detalle ed ON ed.ID_EVIDENCIA=e.ID_EVIDENCIA WHERE ed.ESTADO='1' AND ed.ACTIVO='S'";
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <form action="ViewEvidenciaVerificacion.php" method="POST">
                        <div style="display: flex,justify-content: space-between;">
                            <button class="btn btn-outline-primary" style="border-style: hidden" type="submit" VALUE="<?php echo $row[0] ?>" name="Verificar" > <i class="fas fa-check"></i> Verificar</button>
